...
@app.route("/")
def index():
    return render_template('./aquarium/test_discrib.html')

@app.route("/senddemo")
def senddemo():
    return render_template('./aquarium/test_send.html')
#====================================================================
...
@app.route("/gpuload")
def gpuload ():
    return render_template('gpuload.html')

#=====================================================================start
#=======================fingerprint detect============================
@app.route("/fingerprintdetect")
def fingerprintdetect ():
    return render_template('fpcollect.html')
...
@app.route("/test")
def test():
    return render_template('./HSA/aquarium.html')
